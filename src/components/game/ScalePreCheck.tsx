    ...
    <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-6 sm:space-y-8 animate-in fade-in duration-500">
      ...
      <Card className="border-2 border-indigo-100 shadow-md">
        <CardHeader className="text-center pb-2 px-4">
          <CardTitle className="text-xl sm:text-3xl font-display font-bold text-indigo-700">解鎖測驗：大調音階</CardTitle>
          <p className="text-sm sm:text-base text-slate-500 font-medium mt-1 sm:mt-2">回答正確即可解鎖「音階練習」模組！</p>
        </CardHeader>
