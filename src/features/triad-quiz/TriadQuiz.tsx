  ...
  return (
    <div className="max-w-md mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6 animate-in fade-in duration-500">
      ...
      <div className="text-center py-4 sm:py-6 bg-white rounded-2xl border border-slate-200/60 shadow-sm px-2">
        <p className="text-[10px] sm:text-sm font-semibold text-slate-400 uppercase tracking-wider mb-2 sm:mb-3 whitespace-nowrap">這三個音組成哪個和弦？</p>
        <p className="text-2xl sm:text-4xl font-display font-bold tracking-[0.1em] sm:tracking-[0.2em] text-slate-800">
      ...
      <div className="space-y-2 sm:space-y-3">
        ...
        <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
          {question.typeOptions.map(t => (
            <button
              key={t.key}
              className={`${typeBtnClass(t.key as ChordKey)} py-2 sm:py-2.5 text-xs sm:text-sm`}
